...
const Home=()=>{
    ...
    return(
        <div>
            ...
            <div className="col s12 m6 l5 magic">
...
and to whom you can donate blood.</b>    
            ...
            <div className="row">
            <img  className="materialboxed" src={home5} style={{display:"block",width:"60%",height:"60%",margin:"auto auto"}}></img>
